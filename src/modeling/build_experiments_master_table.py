...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--runs-dir",
        type=Path,
        default=Path("/home/emilio/Documentos/RAdAR/experiments/runs"),
    )
    parser.add_argument(
        "--workbook",
        type=Path,
        default=Path("/home/emilio/Documentos/RAdAR/experiments/audit/grid_experimentos_radar.xlsx"),
    )
    parser.add_argument(
        "--prompts-dir",
        type=Path,
        default=Path("/home/emilio/Documentos/RAdAR/experiments/prompts"),
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("/home/emilio/Documentos/RAdAR/experiments/audit"),
    )
