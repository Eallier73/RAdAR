...
Idea base:
- El Excel `experiments/audit/grid_experimentos_radar.xlsx` sigue siendo el indice maestro.
- Los archivos pesados o reproducibles viven en `experiments/runs/<run_id>_<timestamp>/`.
...
Uso rapido dentro de un script de modelado:
    ...
    from src.modeling.tracking.experiment_logger import RadarExperimentTracker
...
Preparacion inicial del workbook:
    python3 -m src.modeling.tracking.experiment_logger --prepare-workbook
"""
...
DEFAULT_WORKBOOK = ROOT_DIR / "experiments" / "audit" / "grid_experimentos_radar.xlsx"
DEFAULT_RUNS_DIR = ROOT_DIR / "experiments" / "runs"
DEFAULT_PROMPTS_DIR = ROOT_DIR / "experiments" / "prompts"
...
class RadarExperimentTracker:
    ...
    def refresh_master_audit(self) -> dict[str, Any]:
        ...
        """
        from ..reporting.build_experiments_master_table import build_experiments_master_table
