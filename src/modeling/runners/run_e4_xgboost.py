...
from ..core.config import DEFAULT_RANDOM_STATE, TARGET_MODE_LEVEL
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="E4 | Familia boosting con XGBoost bajo walk-forward temporal.",
    )
...
def main() -> None:
    ...
    result = run_tabular_experiment(
        ...
        comentarios=(
            ...
            f"hipotesis={args.hypothesis_note or 'boosting_base_conservador'} | "
