...
Ejemplos:
    python3 src/nlp/generar_lags_datos_ml.py
    python3 src/nlp/generar_lags_datos_ml.py \
...
DEFAULT_INPUT = BASE_DIR / "data" / "processed" / "modeling" / "datos_ml_3.xlsx"
DEFAULT_OUTPUT = BASE_DIR / "data" / "processed" / "modeling" / "datos_ml_4.xlsx"
README_SHEET = "README"
