...
- `medios_extractor.py` deja el `.txt` canónico de medios ya limpiado y segmentado en líneas de 30 palabras dentro de `data/raw/radar_weekly_flat/`; la promoción posterior a `data/text/` replica ese `.txt`, no lo retransforma semánticamente
