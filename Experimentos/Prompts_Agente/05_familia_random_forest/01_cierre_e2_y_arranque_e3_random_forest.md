...
La instrucción previa del proyecto ya decía que, después de cerrar Ridge, el siguiente paso debía ser priorizar una familia no lineal, manteniendo exactamente el mismo marco de evaluación para comparabilidad. 
...
Toma esto como decisión ya resuelta, no como hipótesis abierta. No reabras la discusión salvo que detectes un error objetivo en los artefactos existentes. 
