...
# CONFIGURACIÓN CDMX
# =========================
CDMX_DIR = "/home/emilio/Documentos/Datos_Radar/semana_01octubre_24_07octubre_24/"
CONFIG_START_DATE_STR = "2024-10-01"
CONFIG_END_DATE_STR = "2024-10-07"
...
class TwitterExtractorIAD:
    def __init__(self, fecha_inicio_str, fecha_fin_str, custom_queries=None):
        ...
        # Directorio de salida CDMX
        self.output_dir = Path(CDMX_DIR)
    ...
    def convertir_fecha_a_espanol(self, fecha):
        """Convierte fecha a formato español DDmesAA"""
        meses = {
    ...
    async def extract_replies_for_tweet(self, page, tweet_url: str):
        ...
        while (len(collected) < MAX_REPLIES_PER_TWEET and
               stagnation_count < 6 and
               iteration < MAX_REPLY_SCROLLS):
            visible_tweets = await self.extract_visible_tweets(page)
...
def main():
    ...
    if bool(args.fecha_inicio) != bool(args.fecha_fin):
    ...
    extractor = TwitterExtractorIAD(fecha_inicio, fecha_fin, custom_queries=custom_queries)
