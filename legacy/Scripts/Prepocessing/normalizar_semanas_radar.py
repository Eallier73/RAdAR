...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Normaliza nombres dentro de carpetas semanales de Datos_RAdAR, "
    ...
    parser.add_argument(
        "--report",
        default="/home/emilio/Documentos/RAdAR/Scripts/Prepocessing/reporte_semanas_incompletas.txt",
...
def build_report(
    ...
    *,
    ...
    lines: list[str] = []
    lines.append("Reporte de semanas incompletas de Datos_RAdAR")
