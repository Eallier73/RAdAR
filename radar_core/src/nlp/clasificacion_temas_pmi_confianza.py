...
_DICT_NLP = os.path.join(_BASE_DIR, 'data', 'reference', 'dictionaries_nlp')
_TEXT_DIR = os.path.join(_BASE_DIR, 'data', 'text', 'radar_weekly_flat')

parser.add_argument('--dict_v5', type=str,
    default=os.path.join(_DICT_NLP, 'diccionarios_prueba', 'diccionario_pmi_v5.xlsx'),
    help='Ruta al diccionario PMI ventana 5')
parser.add_argument('--dict_v10', type=str,
    default=os.path.join(_DICT_NLP, 'diccionarios_prueba', 'diccionario_pmi_v10.xlsx'),
    help='Ruta al diccionario PMI ventana 10')
parser.add_argument('--output', type=str,
    default=os.path.join(_DICT_NLP, 'resultados_clasificacion_temas'),
