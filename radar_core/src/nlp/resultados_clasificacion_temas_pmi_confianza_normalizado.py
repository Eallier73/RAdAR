...
INPUT_DEFAULT  = str(Path(_BASE_DIR) / "data" / "reference" / "dictionaries_nlp" / "resultados_clasificacion_temas" / "pmi_confianza_corpus_unido_consolidado.xlsx")
OUTPUT_DEFAULT = str(Path(_BASE_DIR) / "data" / "reference" / "dictionaries_nlp" / "resultados_clasificacion_temas" / "pmi_confianza_corpus_unido_consolidado_normalizado.xlsx")
