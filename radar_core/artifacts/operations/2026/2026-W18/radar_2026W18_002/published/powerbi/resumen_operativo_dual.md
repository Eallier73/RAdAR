...
- `output_dir`: `/home/emilio/Documentos/RAdAR_worktrees/arquitectura_modelado/radar_core/artifacts/operations/2026/2026-W18/radar_2026W18_002/published/powerbi`
...
- `prediccion_numerica_oficial.csv`: `130` fila(s)
- `lectura_direccional_oficial.csv`: `106` fila(s)
- `alertas_caida_oficiales.csv`: `82` fila(s)
- `salida_dual_operativa_consolidada.csv`: `130` fila(s)
