...
ENCUESTAS_PATH = (
    BASE_DIR / "Encuestas" / "Aprobacion_Encuestas_Monica_Villarreal_Oct24_Marzo26.xlsx"
)
SENTIMIENTO_PATH = (
    BASE_DIR / "Datos_Modelo_ML" / "aceptacion_digital_redes_medios_sentimiento_semanal.xlsx"
)
OUTPUT_PATH = BASE_DIR / "Datos_Modelo_ML" / "encuestas_y_sentimiento_mensual_unificado.xlsx"
