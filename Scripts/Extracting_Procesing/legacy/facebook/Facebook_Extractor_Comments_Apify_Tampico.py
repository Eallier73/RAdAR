...
║       --input-csv ./resultados/semana_.../urls_GobiernoCDMX_...csv \     ║
║       --max-comments 200                                                  ║
║                                                                           ║
║  Requisitos:                                                              ║
...
DEFAULT_URLS_BASE_DIR = "/home/emilio/Documentos/Datos_Radar/Facebook/"
...
def encontrar_csv_urls_en_semana(base_dir: str, since_label: str, before_label: str) -> Optional[str]:
    semana_dir = os.path.join(base_dir, f"semana_{since_label}_{before_label}")
...
def encontrar_csv_urls_por_filtros(
    ...
    if since_label and before_label:
        roots.append(os.path.join(base_dir, f"semana_{since_label}_{before_label}"))
...
Flujo típico:
  ...
  2) Bajar con Apify (comentarios, posts o ambos):
     python apify_comentarios.py \\
       --input-csv ./resultados/semana_.../urls_GobiernoCDMX_ClaraBrugadaM_2026-03-01_2026-03-12.csv \\
  ...
  4) Modo interactivo:
    ...
    parser.add_argument("--modo", choices=["posts", "comentarios", "ambos"], default="ambos",
...
def main():
    ...
    output_dir = os.path.join(base_output_dir, f"semana_{since_label}_{before_label}")
