...
DEFAULT_OUTPUT_BASE_DIR = "/home/emilio/Documentos/Datos_Radar/Facebook/semana_2026-03-15_2026-03-31/"
...
def main() -> None:
    ...
    output_dir = os.path.join(args.output_dir, f"semana_{since_label}_{before_label}")
    os.makedirs(output_dir, exist_ok=True)

    targets_label = "_".join(target_handles)
    csv_path = os.path.join(output_dir, f"posts_{targets_label}_{since_label}_{before_label}.csv")
    txt_path = os.path.join(output_dir, f"posts_{targets_label}_{since_label}_{before_label}.txt")
