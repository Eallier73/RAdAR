...
# CONFIGURACION
# =========================
DEFAULT_START_DATE_STR = "2026-03-06"
DEFAULT_END_DATE_STR = "2026-03-12"
...
DEFAULT_OUTPUT_BASE_DIR = "/home/emilio/Documentos/Datos_Radar/Youtube"
DEFAULT_API_KEY = "AIzaSyADmTxdJGJN9_wwahbt-qD0OtaqlEmTKEM"


def convertir_fecha_a_espanol(fecha: datetime) -> str:
    meses = {
        1: "enero", 2: "febrero", 3: "marzo", 4: "abril",
        5: "mayo", 6: "junio", 7: "julio", 8: "agosto",
        9: "septiembre", 10: "octubre", 11: "noviembre", 12: "diciembre",
    }
    return f"{fecha.strftime('%d')}{meses[fecha.month]}"


def calcular_nombre_semana(fecha_inicio: datetime, fecha_fin: datetime) -> str:
    ...
    return f"semana_{fecha_inicio_esp}_{fecha_fin_esp}_{anio}"
...
def main() -> None:
    ...
    output_dir = os.path.join(args.output_dir, nombre_semana)
    ...
    comments_csv = os.path.join(output_dir, f"youtube_comentarios_busquedas_{nombre_semana}.csv")
    comments_txt = os.path.join(output_dir, f"youtube_busquedas_{nombre_semana}.txt")

    transcripts_csv = os.path.join(output_dir, f"youtube_transcripciones_{nombre_semana}.csv")
    transcripts_txt = os.path.join(output_dir, f"youtube_transcripciones_{nombre_semana}.txt")
